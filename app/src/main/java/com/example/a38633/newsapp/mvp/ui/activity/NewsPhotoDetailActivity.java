...
import com.example.a38633.newsapp.mvp.ui.fragment.NewsPhotoDetailFragment;
...
public class NewsPhotoDetailActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.news_photo_detail;
    }
    ...
    protected void onStart() {
        super.onStart();
        //监听图片tab点击
        mRxMannager.on(AppConstant.PHOTO_TAB_CLICK, new Action1<Object>() {
