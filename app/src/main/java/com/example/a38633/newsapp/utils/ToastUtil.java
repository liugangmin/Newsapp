...
//		Toast.makeText(context, strResId, Toast.LENGTH_SHORT).show();
        initToast(App.getContext().getResources().getText(strResId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showLong(int strResId) {
        initToast(App.getContext().getResources().getText(strResId), Toast.LENGTH_LONG).show();
    }
    ...
    public static Toast showToastWithImg(final String tvStr, final int imageResource) {
        ...
        View view = LayoutInflater.from(App.getContext()).inflate(R.layout.toast_custom, null);
